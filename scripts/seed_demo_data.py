...
def _ensure_user(
    ...
    *,
    ...
    if user is None:
        user = User(username=username, role=role, customer_id=customer_id, staff_kind=staff_kind)
...
def main() -> None:
    ...
    with app.app_context():
        ...
        staff = _ensure_user("staff", "staff", staff_kind=User.STAFF_KIND_FORMAL)
        writer_li = _ensure_user("writer_li", "staff", staff_kind=User.STAFF_KIND_FORMAL)
        partner_zhang = _ensure_user("partner_zhang", "staff", staff_kind=User.STAFF_KIND_OUTSOURCE)
